 ...
 * Description: CTA section with title, subtitle and buttons on a dark background.
...
<div class="wp-block-group has-cta-dark-gradient-background has-background has-blanco-color has-text-color"
	...
	<h2
		...
		Want to be part of the change?</h2>
	<!-- /wp:heading -->
	...
	<p class="has-text-align-center"
		...
		Join as a member, volunteer, or just come and meet us. Every action counts.</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-blanco-color has-naranja-background-color has-text-color has-background wp-element-button" href="{membership_url}">Become a member</a></div>
		<!-- /wp:button -->
		<!-- wp:button {"className":"is-style-outline","textColor":"blanco","style":{"border":{"color":"rgba(255,255,255,0.5)","width":"2px"}}} -->
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-blanco-color has-text-color has-border-color wp-element-button" href="{volunteer_url}" style="border-color:rgba(255,255,255,0.5);border-width:2px">Volunteering</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
