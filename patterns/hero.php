 ...
 * Description: Front-page hero section with featured image, gradient, title and CTA buttons.
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group">
			...
			<h1 class="wp-block-heading has-blanco-color has-text-color has-xx-large-font-size"
				style="letter-spacing:-0.02em">Sowing awareness, shaping tomorrow</h1>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.2rem"},"color":{"text":"rgba(255,255,255,0.9)"}}} -->
			<p style="color:rgba(255,255,255,0.9);font-size:1.2rem">A socio-environmental association. Education, conservation and community action.</p>
			<!-- /wp:paragraph -->
